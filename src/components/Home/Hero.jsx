                ...
                <div className="flex xl:justify-center items-center gap-[15px] pt-[17px] max-xl:overflow-x-auto pb-2">
                    <div className="flex items-center gap-[5px]">
                        <CustomButton customOnClick={() => handleTextChange("all")}
                            ...
                            text="All" />
                        <CustomButton customOnClick={() => handleTextChange("pop")}
                            ...
                            text="Pop" />
                        <CustomButton customOnClick={() => handleTextChange("rock")}
                        ...
                        <div className="relative">
                            <CustomButton customOnClick={toggleDropdown}
                                ...
                                text="More" icon={<DownArrow classStyle={`${selectedCategory === "music" ? "stroke-white" : ""} group-hover:stroke-white transition-all duration-300`} />} />
                            {isDropdownOpen && (
                                <div className="absolute left-0 mt-2 bg-white shadow-lg rounded-md z-10">
                                    <button onClick={() => handleTextChange('pop')}
                                        className="text-black !py-2 !px-4 hover:bg-customBlack hover:text-white w-full text-left"
                                    > Pop </button>
                                    <button onClick={() => handleTextChange('rock')}
                                        className="text-black !py-2 !px-4 hover:bg-customBlack hover:text-white w-full text-left"
                                    >  Rock </button>
                                    <button onClick={() => handleTextChange('music')}
                                        className="text-black !py-2 !px-4 hover:bg-customBlack hover:text-white w-full text-left"
                                    > Music </button>
                                </div>
                            )}
